...
// Faça um programa para loja, que solicite o valor total da compra ao usuário e assim, aplique
// um desconto de acordo com o valor total da compra. Siga a tabela:
...
console.log("Valor final da compra com desconto: R$" + valorFinal.toFixed(2));
